...
function Logo({ className }: { className?: string }) {
  return <img src={`${import.meta.env.BASE_URL}logo.jpg`} alt="Repack Pro" className={className} />
}
  ...
  return (
    <div className="min-h-screen">
      ...
      <header className="sticky top-0 z-20 flex items-center gap-2.5 bg-ink-900 px-4 py-3 text-white md:hidden">
        ...
        <div className="text-base font-bold">Repack Pro</div>
        <button
          onClick={toggleTheme}
      ...
      <div className="md:flex">
        ...
        <aside className="sticky top-0 hidden h-screen w-60 shrink-0 flex-col bg-ink-900 text-white md:flex">
          <div className="flex items-center gap-2.5 px-4 py-5">
            ...
            <div>
              <div className="text-sm font-bold leading-tight">Repack Pro</div>
